...
const MarkdownRenderer = ({ content }) => {
  return (
    <div className='text-netural-700'>
      <ReactMarkdown
        ...
        components={{
          ...
          blockquote: ({ node, ...props }) => <blockquote className='border-netural-300 pl-4 italic text-netural-600 my-4' {...props} />,
          ...
          pre: ({ node, ...props }) => <pre className='bg-netural-800 text-white p-3 rounded-md overflow-x-auto font-mono text-sm my-4' {...props} />
        }} >
        {content}
      </ReactMarkdown>
    </div>
