...
const Flashcard = ({ flashcard, onToggleStar }) => {
    ...
    return <div className="relative w-full h-72" style={{ perspective: '1000px' }}>
        <div
            ...
            <div
            className="absolute inset-0 w-full h-full bg-linear-to-br from-slate-500 to-slate-500 border-2 border-slate-400/60 rounded-2xl shadow-xl shadow-slate-500/30 p-8 flex flex-col justify-between"
            style={{
                backfaceVisibility:'hidden',
                WebkitBackfaceVisibility: 'hidden',
                ...
                <div className="flex justify-end">
                    ...
                    className={`w-9 h-9 rounded-xl flex items-center justify-center transition-all duration-200 ${
                        ...
                        : 'bg-white/20 backdrop-lur-sm text-white/70 hover:bg-white/30 hover:text-white border border-white/20'
                    }`}>
                        <Star
                        className="w-4 h-4"
                        strokeWidth={2}
