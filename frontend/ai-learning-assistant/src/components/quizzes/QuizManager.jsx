...
const QuizManager = ({ documentId }) => {
    ...
    return (
        <div className='bg-white border border-netural-200 rounded-lg p-6'>
            ...
            title="Generate New Quiz" >
                ...
                <form onSubmit={handleGenerateQuiz} className='space-y-4'>
                    <div>
                        <label className='block text-xs font-medium text-netural-700 mg-1.5'>
                            Number of Questions
                        </label>
                        <input
                        type='number'
                        ...
                        min="1"
                        required
                        className='w-full h-9 px-3 border border-netural-200 rounded-lg bg-white text-sm text-netural-900 placeholder-netural-400 transition-color duration-150 focus:outline-none focus:ring-2 focus:ring-[#00d492] focus:border-transparent'/>
                    </div>
