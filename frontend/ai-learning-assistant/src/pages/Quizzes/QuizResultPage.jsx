...
const QuizResultPage = () => {
  ...
  if (loading) {
    return (
      <div className='flex items-center jusitify-center min-h-[60vh]'>
        <Spinner />
      </div>
    );
  }
    ...
    <div className='max-w-5xl mx-auto'>
      ...
      <div className='mb-6'>
        <Link
          ...
          className='group initial-flex items-center gap-2 text-sm font-medium text-slate-600 hover:text-emerald-600 transition-colors duration-200'>
      ...
      <div className='space-y-6'>
        ...
        {detailedResults.map((result, index) => {
          ...
          return (
            <div
              key={index}
              className='bg-white/80 backdrop-blur-xl border-2 border-slate rounded-2xl p-6 shadow-lg shadow-slate-200/50'>
              <div className='flex items-start juestify-between gap-4 mb-3'>
